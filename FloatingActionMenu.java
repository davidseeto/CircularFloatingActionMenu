...
public class FloatingActionMenu {
    ...
    public View getActivityContentView() {
        try {
            ...
            try {
                //Try to unwrap as a context wrapper
                return ((Activity)((ContextWrapper) context).getBaseContext()).getWindow().getDecorView().findViewById(android.R.id.content);
            } catch (ClassCastException e) {
               //Try to unwrap as activity
